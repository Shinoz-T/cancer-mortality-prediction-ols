...
df = ingest_data.get_data(r"D:\Cancer mortality prediction\ols regression challenge data\data\cancer_reg.csv")
...
df.to_csv(r"D:\Cancer mortality prediction\ols regression challenge data\data\cancer_reg_processed.csv")